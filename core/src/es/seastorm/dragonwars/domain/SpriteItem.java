...
public abstract class SpriteItem extends Item {
    ...
    public SpriteItem(String image, Float x, Float y, Float angle) {
        super(new Texture(image));
        initialize(x, y, angle);
        this.picture = image;
    }

    public SpriteItem(Texture image, Float x, Float y, Float angle) {
        super(image);
        initialize(x, y, angle);
    }
